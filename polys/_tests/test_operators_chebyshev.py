...
class Suite(unittest.TestCase):
    ...
    def _validate_operator(self, key):
        ...
        opr = opr.with_nodes(point)
        opr = opr.with_polys(index)
...
class TestPolys(Suite):
    ...
    OPERATOR = polys.Chebyshev().polys()
...
class TestDerivs(Suite):
    ...
    OPERATOR = polys.Chebyshev().derivs(order=1)
...
class TestIntegT0Tn(Suite):
    ...
    OPERATOR = polys.chebyshev.IntegT0Tn()
...
class TestIntegT1Tn(Suite):
    ...
    OPERATOR = polys.chebyshev.IntegT1Tn()
...
class TestIntegT0TnAX(Suite):
    ...
    OPERATOR = polys.Chebyshev().integax(weighted=False)
...
class TestIntegT0TnXB(Suite):
    ...
    OPERATOR = polys.Chebyshev().integxb(weighted=False)
...
class TestIntegT1TnAX(Suite):
    ...
    OPERATOR = polys.Chebyshev().integax(weighted=True)
...
class TestIntegT1TnXB(Suite):
    ...
    OPERATOR = polys.Chebyshev().integxb(weighted=True)
