...
<pre class="py-sign"><b><em>class</em></b> hpsolver.polys.<b>PolyBasis</b>()</pre>
...
<pre class="py-sign">PolyBasis.<b>derivs</b>(<em>self</em>, order=1)</pre>

Returns an *operator* that differentiates polynomials.

<b>Parameters</b>

<p><span class="vardef"><code>order</code> : <em>int = 1</em></span></p>
...
<pre class="py-sign"><b><em>class</em></b> hpsolver.polys.<b>PolyOpr</b>()</pre>

ABC for operators on a polynomial sequence.

### with_nodes()

<pre class="py-sign">PolyOpr.<b>with_nodes</b>(<em>self</em>, nodes)</pre>
...
<pre class="py-sign">PolyOpr.<b>with_polys</b>(<em>self</em>, *indices)</pre>
...
<pre class="py-sign"><b><em>class</em></b> hpsolver.polys.<b>NodeSet</b>()</pre>
...
<pre class="py-sign"><b><em>class</em></b> hpsolver.polys.<b>Legendre</b>()</pre>

Basis formed by the Legendre polynomials.

## Chebyshev

<pre class="py-sign"><b><em>class</em></b> hpsolver.polys.<b>Chebyshev</b>()</pre>

Basis formed by the Chebyshev polynomials of the 1st kind.

## lgngauss()

<pre class="py-sign">hpsolver.polys.<b>lgngauss</b>(count=<span>None</span>)</pre>

Returns the Legendre-Gauss node set.

<b>Parameters</b>

<p><span class="vardef"><code>count</code> : <em>int = None</em></span></p>
...
<p><span class="vardef"><em>NodeSet</em></span></p>
...
<pre class="py-sign">hpsolver.polys.<b>lbtgauss</b>(count)</pre>
...
<pre class="py-sign">hpsolver.polys.<b>chbgauss</b>(count=<span>None</span>)</pre>
...
<pre class="py-sign">hpsolver.polys.<b>chblobatto</b>(count=<span>None</span>)</pre>
